...
- Windows NVIDIA 运行时同时携带对应版本的 NVRTC 编译器与 builtins，供 cuDNN 在新显卡上生成运行时内核；RTX 50/TensorRT 包固定校验官方 CUDA `12.8.61` NVRTC 归档 SHA-256 `e43603b09f8a52d681ceb814c00b655af19da53692ab91671dabbf8071c8f93d`，发布审计会同时检查精确 DLL 和 manifest 记录，避免解压即引擎启动失败
