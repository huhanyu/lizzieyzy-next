...
/**
 * GoAgent data/knowledge 下的 markdown
 * 棋理知识文档（proverbs/shapes/strategy/life-death/joseki/ko/tesuji/endgame，39 篇）。 GoAgent
 * 运行时未加载这些文档（属静态知识资产），这里提供按需加载 + 关键词搜索， 使讲解可引用棋理格言/死活/手筋/官子等教学文本。
 */
public final class MarkdownKnowledgeLoader {
  ...
  public static final String[] CATEGORIES = {
    "proverbs", "shapes", "strategy", "life-death", "joseki", "ko", "tesuji", "endgame"
  };

  private static final Map<String, Map<String, String>> cache =
      new HashMap<>(); // category -> (title -> content)
  ...
  public static Map<String, String> loadCategory(String category) {
    ...
    for (String file : files) {
      try (InputStream in =
          MarkdownKnowledgeLoader.class.getResourceAsStream(
              "/knowledge/markdown/" + key + "/" + file)) {
        if (in == null) continue;
    ...
    switch (category) {
      case "proverbs":
        return Arrays.asList(
            "ai-insights.md",
            "direction-thickness.md",
            "endgame.md",
            "middle-game.md",
            "opening.md");
      case "shapes":
        return Arrays.asList("connections.md", "eye-shapes.md", "good-bad-shapes.md");
      case "strategy":
        return Arrays.asList(
            "aji.md",
            "attack-defense.md",
            ...
            "handicap.md",
            "heavy-light.md",
            "influence-territory.md",
            "invasion-reduction.md",
            "moyo.md",
            "reading.md",
            "sabaki.md",
            "semeai.md",
            ...
            "vital-expendable.md");
      case "life-death":
        return Arrays.asList("basics.md", "corner-patterns.md", "seki.md", "side-patterns.md");
      case "joseki":
        return Arrays.asList("33-invasion.md", "34-point.md", "high-approach.md", "star-point.md");
      case "ko":
        return Arrays.asList("basics.md", "ko-fights.md");
      case "tesuji":
        return Arrays.asList("common-tesuji.md", "cutting.md", "peep-probe.md", "sacrifice.md");
      case "endgame":
        return Arrays.asList("counting-endgame.md", "endgame-tesuji.md");
      default:
  ...
  public static Map<String, String> loadAll() {
    ...
    for (String cat : CATEGORIES) {
      for (Map.Entry<String, String> e : loadCategory(cat).entrySet())
        all.put(cat + "/" + e.getKey(), e.getValue());
    }
    return all;
  }
